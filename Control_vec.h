...
namespace Control {
    ...
    //                                                  
                                                      //left mtr                      //right mtr
    const Control_vec forward =      {"forward",      Direction::fwd,  100,           Direction::fwd,  100};
    ...
    const Control_vec backward_twist_cw={"back_twist_cw",   Direction::back,  20,     Direction::back, 100};
    const Control_vec backward_twist_ccw={"back_twist_ccw",   Direction::back,  125,  Direction::back,  10};
